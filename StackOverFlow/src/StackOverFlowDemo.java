...
public class StackOverFlowDemo
{
    public static void main(String[] args)
    {
        ...
        Question question = service.postQuestion(alice, "How to implement Observer Pattern?", "Details about Observer Pattern...", tags);
        printReputations(alice, bob, charlie);

        // 3. Bob and Charlie post answers
        System.out.println("\n--- Bob and Charlie post answers ---");
        Answer bobAnswer = service.postAnswer(bob, question.getId(), "You can use the java.util.Observer interface.");
        Answer charlieAnswer = service.postAnswer(charlie, question.getId(), "A better way is to create your own Observer interface.");
        printReputations(alice, bob, charlie);

        // 4. Voting happens
        System.out.println("\n--- Voting Occurs ---");
        service.voteOnPost(bob, question.getId(), VoteType.UPVOTE); // Bob upvotes Alice's question
        ...
        System.out.println("\n--- Comments ---");
        service.addComment(bob, question.getId(), "Can you share what you have tried?");
        service.addComment(alice, charlieAnswer.getId(), "Glad this worked for you!");
